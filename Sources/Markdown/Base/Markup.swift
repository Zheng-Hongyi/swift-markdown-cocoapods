...
extension Markup {
  ...
  public func withUncheckedChildren<Children: Sequence>(_ newChildren: Children) -> Markup
  where Children.Element == Markup {
...
extension Markup {
  ...
  public var detachedFromParent: Markup {
    ...
    let newRaw = AbsoluteRawMarkup(
      markup: raw.markup, metadata: MarkupMetadata(id: .newRoot(), indexInParent: 0))
...
private struct SoftBreakDeleter: MarkupRewriter {
