...
extension Document {
  ...
  public init(parsing string: String, source: URL? = nil, options: ParseOptions = []) {
    if options.contains(.parseBlockDirectives) {
      self = BlockDirectiveParser.parse(
  ...
  /// - parameter options: options for parsing Markdown text.
  public init(parsing file: URL, options: ParseOptions = []) throws {
