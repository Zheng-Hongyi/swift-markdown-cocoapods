...
extension ListItem {
  ...
  public init(checkbox: Checkbox? = .none, _ children: BlockMarkup...) {
  ...
  /// - Parameter checkbox: An optional ``Checkbox`` for the list item.
  /// - Parameter children: The child block elements of the list item.
  public init<Children: Sequence>(checkbox: Checkbox? = .none, _ children: Children)
  ...
  public var checkbox: Checkbox? {
    ...
    set {
      _data = _data.replacingSelf(
        .listItem(checkbox: newValue, parsedRange: nil, _data.raw.markup.copyChildren()))
    }
  }
