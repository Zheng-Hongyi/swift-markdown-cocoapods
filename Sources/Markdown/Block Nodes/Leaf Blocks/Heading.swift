...
extension Heading {
  ...
  public init<Children: Sequence>(level: Int, _ children: Children)
  where Children.Element == InlineMarkup {
  ...
  public var level: Int {
    ...
    set {
      ...
      _data = _data.replacingSelf(
        .heading(level: newValue, parsedRange: nil, _data.raw.markup.copyChildren()))
    }
  }
  ...
  /// Create a heading with a level and a sequence of children.
  public init(level: Int, _ children: InlineMarkup...) {
