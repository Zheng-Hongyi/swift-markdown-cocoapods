...
extension Table {
  ...
  public init(
    columnAlignments: [ColumnAlignment?]? = nil,
    header: Head = Head(),
    body: Body = Body()
  ) {
    try! self.init(
  ...
  public var columnAlignments: [Table.ColumnAlignment?] {
    get {
...
extension Array where Element == Table.ColumnAlignment? {
  fileprivate func ensuringCount(atLeast minCount: Int) -> Self {
    if count < minCount {
