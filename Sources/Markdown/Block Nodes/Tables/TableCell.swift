...
extension Table.Cell {
  ...
  public var colspan: UInt {
    ...
    set {
      _data = _data.replacingSelf(
        .tableCell(
          parsedRange: nil, colspan: newValue, rowspan: rowspan, _data.raw.markup.copyChildren()))
    }
  }
  ...
  public var rowspan: UInt {
    ...
    set {
      _data = _data.replacingSelf(
        .tableCell(
          parsedRange: nil, colspan: colspan, rowspan: newValue, _data.raw.markup.copyChildren()))
    }
  }
