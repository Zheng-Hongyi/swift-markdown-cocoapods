...
extension BlockContainer {
  ...
  public var blockChildren: LazyMapSequence<MarkupChildren, BlockMarkup> {
    return children.lazy.map { $0 as! BlockMarkup }
  }

  /// Replace all inline child elements with a new sequence of inline elements.
  public mutating func setBlockChildren<Items: Sequence>(_ newChildren: Items)
  where Items.Element == BlockMarkup {
