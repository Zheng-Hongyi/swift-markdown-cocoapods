...
class SourceURLTests: XCTestCase {
  func testParseStringURLSource() {
    ...
    let document = Document(
      parsing: text, source: source, options: [.parseBlockDirectives, .parseSymbolLinks])
  ...
  func testParseString_SmartOpts() {
    let text =
      "The iPod (2001--2022) changed the way people listened and interacted with music---it'll forever be in our hearts!"
